...
with BuildPart() as outer_ring:
    # maak een ring waarin je schroefdraad kan plaatsen met daarom heen
    # een torus die kan gebruikt worden als slider.
    Cylinder(6.0, 2, align=(Align.CENTER, Align.CENTER, Align.CENTER))
    Cylinder(5.0, 5, align=(Align.CENTER, Align.CENTER, Align.CENTER))
    Cylinder(
        4.5, 5, align=(Align.CENTER, Align.CENTER, Align.CENTER), mode=Mode.SUBTRACT
    )
    # HELIX MOET NOG GEPLAATST,
    # maar beetje zonde om die 2x te defineren..

with BuildPart() as hinge_base:
    Cylinder(6.5, 5)

    # maak onderdelen aan de slider waar vervolgens weer een scharnier
